...
namespace HG151515_MIS4200.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,courseDescription,courseLocation,courseStart,instructorID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,courseDescription,courseLocation,courseStart,instructorID")] Course course)
        {
            if (ModelState.IsValid)
            {
