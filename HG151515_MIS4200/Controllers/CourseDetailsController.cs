...
using HG151515_MIS4200.DAL;
using HG151515_MIS4200.Models;

namespace HG151515_MIS4200.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        {
            var courseDetails = db.CourseDetails.Include(c => c.Instructor);
        ...
        public ActionResult Create([Bind(Include = "coursedetailID,coursedetailDescription,coursestartTime,courseID,InstructorID")] CourseDetail courseDetail)
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors, "instructorID", "instructorfirstName", courseDetail.InstructorID);
            return View(courseDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "coursedetailID,coursedetailDescription,coursestartTime,courseID,InstructorID")] CourseDetail courseDetail)
        {
            if (ModelState.IsValid)
            {
